...
const ProjectPage = () => {
  ...
  return (
    <Layout>
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-xl border border-[#e8e8ef] bg-white p-5 shadow-xs dark:bg-slate-900 dark:border-slate-800">
        <div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Button
            ...
            className="border-[#e8e8ef] text-[#1a1a2e]"
          >
      ...
      {/* Tabs Header */}
      <div className="mb-6 flex items-center gap-2 border-b border-[#e8e8ef] pb-2 overflow-x-auto">
        <Button
        ...
        <div className="lg:col-span-2">
          {activeTab === 'feed' && (
            <Card className="border-[#e8e8ef] bg-white shadow-sm">
              <CardHeader className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-[#e8e8ef] px-4 sm:px-5 py-4">
              ...
              <div className="p-4 border-b border-[#f0f0f5] bg-[#fafafa] flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-9 h-8 text-xs bg-white border-[#e8e8ef]"
                  />
                </div>
